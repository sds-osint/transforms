...
@openpeoplesearch_registry.register_transform(
    display_name="Search Company [OPS]", 
    input_entity="maltego.Company",
    description="Search OpenPeopleSearch for a Company",
    settings=[],
    output_entities=["maltego.Person", "maltego.Phrase"]
)

class ops_company(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        json_data = {
            "businessName": request.getProperty("title"),
