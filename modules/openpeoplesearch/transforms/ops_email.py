...
@openpeoplesearch_registry.register_transform(
    display_name="Search Email [OPS]", 
    input_entity="maltego.Email",
    description="Search OpenPeopleSearch for an Email Address",
    settings=[],
    output_entities=["maltego.Email", "maltego.Phrase"]
)

class ops_email(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        json_data = {
            'emailAddress': request.getProperty("email"),
        }
