...
@openpeoplesearch_registry.register_transform(
    display_name="Search Person [OPS]", 
    input_entity="maltego.Person",
    description="Search OpenPeopleSearch for a Person",
    settings=[],
    output_entities=["maltego.Person", "maltego.Phrase"]
)

class ops_person(DiscoverableTransform):
    ...
    def create_entities(cls, request: MaltegoMsg, response: MaltegoTransform):
        ...
        first_name = request.getProperty("person.firstnames")
        last_name = request.getProperty("person.lastname")
        full_name = request.getProperty("person.fullname")
